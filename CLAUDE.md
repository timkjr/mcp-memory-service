...
**Current Version:** v11.0.1 - PATCH: bootstrap profile + harvest-aware session hooks (commit_session_legacy wiring for claude-hooks and opencode plugin) — 2,399 tests — see [CHANGELOG.md](CHANGELOG.md) for details
