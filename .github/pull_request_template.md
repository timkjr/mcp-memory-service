...
## Security (required for tool/auth/storage changes)

<!--
Complete this section if your PR:
- Adds or modifies an MCP tool
- Touches OAuth/scope enforcement (web/api/mcp.py, server_impl.py write-scope gate)
- Modifies storage logic
Otherwise delete this section.
-->

- **Read-only or write tool?**
- **Scope enforcement**: how is write access gated for the new/modified tool?
- **`valid_actions` updated?** (required if routed through `handle_memory_graph()`)
- **Edge cases**: None/missing arguments, malformed input, concurrent access considered?

## Agent Disclosure

<!--
If this PR was generated or submitted by an automated agent (AI system without
direct human review of each change), complete this section. Otherwise delete it.
Omitting this section when the PR is agent-generated may result in the PR being
closed pending clarification. See CONTRIBUTING.md for details.
-->

This PR was generated by **[agent name/system]**. Operated by **[human / org]**.

Human review performed: **[yes — describe scope / no — fully automated]**
...
- [ ] ✅ **If adding/modifying MCP tools**: write-scope enforcement verified, `valid_actions` updated if needed
